...
class _CampSitePageState extends State<CampSitePage> {
  late final Battler _healedPlayer;
  late final int _healedAmount;

  @override
  void initState() {
    super.initState();
    final recoveryAmount = (widget.player.maxHealth * 0.5).ceil();
    _healedPlayer = widget.player.heal(recoveryAmount);
    _healedAmount = _healedPlayer.health - widget.player.health;
  }

  void _closeCamp() {
    Navigator.of(context).pop(_healedPlayer);
  }
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text(
                        'Recuperas 50% de tu vida máxima.',
                        textAlign: TextAlign.center,
                      ...
                      Text(
                        '${widget.player.health} / ${widget.player.maxHealth}  ->  ${_healedPlayer.health} / ${_healedPlayer.maxHealth}',
                        textAlign: TextAlign.center,
                      ...
                      Text(
                        _healedAmount > 0
                            ? 'Salud recuperada: +$_healedAmount'
